          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: saleAttrValue.isChecked == 1 }" v-for="saleAttrValue in saleAttr.spuSaleAttrValueList" :key="saleAttrValue.id" @click="changeActive(saleAttrValue, saleAttr.spuSaleAttrValueList)">
...
<script>
import ImageList from '@/views/Detail/ImageList.vue'
import Zoom from '@/views/Detail/Detail.vue'
...
export default {
  ...
  methods: {
    ...
    async addToShopCart() {
      // 发起请求（通知服务器，添加产品到数据库）
      console.log('index vue start')
      try {
        console.log('index', this.$route.params.skuid, this.skuNum)
